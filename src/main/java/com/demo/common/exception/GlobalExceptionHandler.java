...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResult<?>> handleDuplicatedUserException(DuplicatedException e) {
		return ResponseEntity.status(e.getError().getStatus()).body(ApiResult.createError(e.getError().getMessage()));
	}
	...
	public ResponseEntity<ApiResult<?>> exception(CustomException exception) {
